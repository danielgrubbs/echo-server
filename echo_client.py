...
def client(msg, log_buffer=sys.stderr):
    ...
    try:
        ...
        print('Unable to instantiate socket. Error code: {}'.format(str(e)))
    ...
    try:
        ...
        # Example of the TODO: https://docs.python.org/3.6/howto/sockets.html
        # at the bottom of MySocket class describing using a fixed length message
        # chunk = ''
        bytes_recd = 0
